...
local function env_import(env)
    ...
    append(packages, 'com.open.lua.widget.')
    append(packages, 'com.open.lua.util.')
    append(packages, 'github.daisukiKaffuChino.reopenlua.')
    append(packages, 'github.daisukiKaffuChino.reopenlua.utils.')
