...
dlg=AppCompatDialog(activity,MDC_R.style.Theme_Material3_DynamicColors_DayNight)
dlg.setTitle("布局表预览")
function show(s)
...
loadlayout(t)
dlg2=AppCompatDialog(activity,MDC_R.style.Theme_Material3_DynamicColors_DayNight)
dlg2.setTitle("编辑代码")
